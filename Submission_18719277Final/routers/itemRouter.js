...
const { isAuthNeededMiddleware, createOrEditMiddlewareValidator } = require("../utils");
...
module.exports = router => {
  ...
  // router.post("/create", createOrEditMiddlewareValidator, itemController.post.create);
  ...
  router.post("/create", isAuthNeededMiddleware(), createOrEditMiddlewareValidator, itemController.post.create);
  router.post("/edit/:itemId", isAuthNeededMiddleware(), createOrEditMiddlewareValidator, itemController.post.edit);
